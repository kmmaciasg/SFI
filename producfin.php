...
$nombre_completo = $nombre_usuario . " " . $apellido_usuario;
	...
	$permiso = 'ingresar y egresar producto terminado';
  ...
  <?php } ?></i>
	...
	<div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
		<div class="mdl-tabs__tab-bar">
			<a href="#tabNewProduct" class="mdl-tabs__tab is-active">INGRESAR PRODUCTO</a>
			<a href="#tabNewEgreso" class="mdl-tabs__tab">SALIDA DE PRODUCTO</a>
		</div>
...
<script>
function enviarDatos2() {// verificar si el usuario tiene permiso para acceder a esta página
...
<div class="mdl-grid">
    ...
    <form method="post" action="insertar_producto.php">
