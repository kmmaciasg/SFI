...
$sql = "SELECT descripcion FROM embalaje";
...
<div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
    <div class="mdl-tabs__tab-bar">
        <a href="#tabNewProduct" class="mdl-tabs__tab is-active">INGRESAR EMBALAJE</a>
        <a href="#tabNewEgreso" class="mdl-tabs__tab">SALIDA DE EMBALAJE</a>
    </div>
            ...
            <div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop">
                <div class="full-width panel mdl-shadow--2dp">
                    ...
                    <div class="full-width panel-content">
                        <form id="formulario" name="formulario" method="POST" action="embalaje.php" onsubmit="return enviarDatos();">
                            <div class="mdl-grid">
                                ...
                                <div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop">
								   <h6 class="text-condensedLight">Selecciona el embalaje
											<?php
        ...
        <div class="mdl-grid">
            <div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop">
                <div class="full-width panel mdl-shadow--2dp">
                    ...
                    <div class="full-width panel-content">
                        <form id="formulario2" name="formulario2" method="POST" action="embalaje.php" onsubmit="return enviarDatos2();">
                            <div class="mdl-grid">
                                <div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop">
								    <h6 class="text-condensedLight">Selecciona el embalaje
											<?php
                            ...
                            <p class="text-center">
                                ...
                                <div class="mdl-tooltip" for="EgresarProducto">Sacar Embalaje</div>
                            </p>
                        </form>
                    </div>
                </div>
...
function enviarDatos() {
  ...
  xmlhttp.open("POST", "hiembalajes.php", true);
  ...
  xmlhttp2.open("POST", "aiembalajes.php", true);
...
function enviarDatos2() {
  ...
  // Creamos un objeto XMLHttpRequest para enviar los datos a actualizarinventario.php
  var xmlhttp = new XMLHttpRequest();
  xmlhttp.open("POST", "aiembalajes2.php", true);
  xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xmlhttp.send("opciones2=" + producto  + "&cant2=" + cantidad );

  // Creamos otro objeto XMLHttpRequest para enviar los datos a guardarhistorial.php
  var xmlhttp2 = new XMLHttpRequest();
  xmlhttp2.open("POST", "heembalajes.php", true);
  xmlhttp2.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
<div class="mdl-grid">
    ...
    <form method="post" action="insertar_embalaje.php">
