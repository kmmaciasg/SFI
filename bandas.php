...
$sql = "SELECT descripcion FROM bandas";
...
?>
	...
	<div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
		<div class="mdl-tabs__tab-bar">
			<a href="#tabNewProduct" class="mdl-tabs__tab is-active">INGRESAR BANDAS</a>
			<a href="#tabNewEgreso" class="mdl-tabs__tab">SALIDA DE BANDAS</a>
		</div>
				...
				<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop">
					<div class="full-width panel mdl-shadow--2dp">
						<div class="full-width panel-tittle bg-primary text-center tittles">
							Ingreso de Bandas de Seguridad
						</div>
						<div class="full-width panel-content">
							<form id="formulario" name="formulario" method="POST" action="bandas.php" onsubmit="return enviarDatos();">
								<div class="mdl-grid">
									...
									<label for="fecha">Fecha de ingreso:</label>
										...
										<div class="mdl-textfield mdl-js-textfield">
											...
											<label class="mdl-textfield__label" for="Empleado">Nombre de quien ingresa la banda</label>
											<span class="mdl-textfield__error">Nombre Invalio</span>	
										</div>
									</div>
									<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop">
									<h6 class="text-condensedLight">Selecciona la Banda
											<?php
								...
								<p class="text-center">
									<button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored bg-primary" type="submit" id="AgregarProducto">
										...
										<div class="mdl-tooltip" for="AgregarProducto">Ingresar Banda</div>
									</button>
									<button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored bg-primary" style="margin-left: 55px;" id="CrearProducto">
										...
										<div class="mdl-tooltip" for="CrearProducto">Crear Nueva Banda</div>
									</button>
		...
		<div class="mdl-tabs__panel" id="tabNewEgreso">
			<div class="mdl-grid">
				<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop">
					<div class="full-width panel mdl-shadow--2dp">
						<div class="full-width panel-tittle bg-primary text-center tittles">
							Salida de Bandas de Seguridad
						</div>
						<div class="full-width panel-content">
							<form id="formulario2" name="formulario2" method="POST" action="bandas.php" onsubmit="return enviarDatos2();">
								<div class="mdl-grid">
									<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop">
									...
									<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
										...
										<div class="mdl-textfield mdl-js-textfield">
											...
											<label class="mdl-textfield__label" for="Empleado">Nombre de quien Egresa la banda</label>
											<span class="mdl-textfield__error">Nombre Invalio</span>
										</div>
									</div>
								</div>
								<p class="text-center">
									...
									<div class="mdl-tooltip" for="EgresarProducto">Sacar Banda</div>
								</p>
							</form>
						</div>
					</div>
...
function enviarDatos() {
  ...
  xmlhttp.open("POST", "hibandas.php", true);
  ...
  xmlhttp2.open("POST", "aibandas.php", true);
...
function enviarDatos2() {
  ...
  // Creamos un objeto XMLHttpRequest para enviar los datos a actualizarinventario.php
  var xmlhttp = new XMLHttpRequest();
  xmlhttp.open("POST", "aibandas2.php", true);
  xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xmlhttp.send("opciones2=" + producto  + "&cant2=" + cantidad );

  // Creamos otro objeto XMLHttpRequest para enviar los datos a guardarhistorial.php
  var xmlhttp2 = new XMLHttpRequest();
  xmlhttp2.open("POST", "hebandas.php", true);
  xmlhttp2.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
