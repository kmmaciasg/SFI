...
$(document).ready(function() {
    ...
    $("#eliminar").click(function() {
        ...
        var id_lote = prompt("Introduce la tapa a eliminar:");

        // Realizamos la petición AJAX para eliminar el lote
        $.ajax({
            url: "eliminar_tapas.php",
            type: "POST",
            ...
            error: function() {
                alert("Error al eliminar la tapa");
            }
        });
    })
});
...
$(document).ready(function() {
    ...
    $("#eliminar1").click(function() {
        event.preventDefault()
        // Pedimos al usuario el ID del lote
        var id_lote = prompt("Introduce la banda a eliminar:");

        // Realizamos la petición AJAX para eliminar el lote
        $.ajax({
            url: "eliminar_bandas.php",
            type: "POST",
            data: {id_lote: id_lote},
            success: function(resultado) {
                // Mostramos un mensaje indicando si se ha eliminado el registro correctamente o no
	...
	<script>
        $(document).ready(function() {
            ...
            $("#modificar").click(function() {
				event.preventDefault()
                // Pedimos al usuario el ID del lote
                var id_lote = prompt("Introduce la tapa a modificar:");

                // Realizamos la petición AJAX para buscar el lote
                $.ajax({
                    url: "buscar_tapas.php",
                    type: "POST",
                    data: {id_lote: id_lote},
                    dataType: "json",
                    success: function(resultado) {
...
<script>
        $(document).ready(function() {
            ...
            $("#modificar1").click(function() {
				event.preventDefault()
                // Pedimos al usuario el ID del lote
                var id_lote1 = prompt("Introduce la banda a modificar:");

                // Realizamos la petición AJAX para buscar el lote
                $.ajax({
                    url: "buscar_bandas.php",
                    type: "POST",
...
include 'conexion_db.php';
				...
				// Consultar la tabla
				$sql = "SELECT Descripcion, cantidad, stock_limite  FROM tapas";
				$resultado = $conexion->query($sql);

				// Consultar la tabla
				$sql1 = "SELECT descripcion, cant, stock_limite  FROM bandas";
...
<div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
    <div class="mdl-tabs__tab-bar">
        <a href="#tabNewProduct" class="mdl-tabs__tab is-active">Inventario de Tapas </a>
        <a href="#tabNewEgreso" class="mdl-tabs__tab">Inventario de Bandas</a>
    </div>
                            ...
                            <div class="mdl-grid">
								...
								<table id="tabla_productos" class="mdl-data-table mdl-js-data-table mdl-shadow--2dp full-width table-responsive">
									...
									<button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored bg-primary" type="submit"style="margin-left:450px"  id="modificar" >
										...
										</button>	<button class="mdl-button mdl-js-button mdl-button--fab mdl-js-ripple-effect mdl-button--colored bg-primary" type="submit"id="eliminar" >
                        ...
                        <form>
                            <div class="mdl-grid">
								...
								<table id="tabla_productos1" class="mdl-data-table mdl-js-data-table mdl-shadow--2dp full-width table-responsive">
									<thead>
                                            <tr>
                                            <th class="mdl-data-table"style="text-align: center;">TIPO DE BANDA</th>
                                            <th class="mdl-data-table" style="text-align: center;">CANTIDAD</th>
                                            <th class="mdl-data-table" style="text-align: center;">STOCK LIMITE</th>
                                            </tr>
                                        </thead>
