...
?>
<?php
// Archivo eliminar_lote.php

// Conectamos con la base de datos
$conexion = mysqli_connect("localhost", "root", "", "lachila");

// Obtenemos el ID del lote a eliminar
$id_lote = $_POST["id_lote"];

// Realizamos la consulta para eliminar el registro de la base de datos
$query = "DELETE FROM productos WHERE Descripcion = '$id_lote'";
mysqli_query($conexion, $query);

// Verificamos si se ha eliminado algún registro
if (mysqli_affected_rows($conexion) > 0) {
    echo "El registro se ha eliminado correctamente.";
} else {
    echo "El registro no se ha encontrado en la base de datos.";
}
