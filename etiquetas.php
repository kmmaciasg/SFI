...
$sql = "SELECT descripcion FROM etiquetas";
				...
				<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop">
					<div class="full-width panel mdl-shadow--2dp">
						...
						<div class="full-width panel-content">
							<form id="formulario" name="formulario" method="POST" action="etiquetas.php" onsubmit="return enviarDatos();">
								<div class="mdl-grid">
			...
			<div class="mdl-grid">
				<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop">
					<div class="full-width panel mdl-shadow--2dp">
						...
						<div class="full-width panel-content">
							<form id="formulario2" name="formulario2" method="POST" action="etiquetas.php" onsubmit="return enviarDatos2();">
								<div class="mdl-grid">
									<div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--6-col-desktop">
...
function enviarDatos() {
  ...
  xmlhttp.open("POST", "hietiquetas.php", true);
  ...
  xmlhttp2.open("POST", "aietiquetas.php", true);
...
function enviarDatos2() {
  ...
  // Creamos un objeto XMLHttpRequest para enviar los datos a actualizarinventario.php
  var xmlhttp = new XMLHttpRequest();
  xmlhttp.open("POST", "aietiquetas2.php", true);
  xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xmlhttp.send("opciones2=" + producto  + "&cant2=" + cantidad );

  // Creamos otro objeto XMLHttpRequest para enviar los datos a guardarhistorial.php
  var xmlhttp2 = new XMLHttpRequest();
  xmlhttp2.open("POST", "heetiquetas.php", true);
  xmlhttp2.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
<div class="mdl-grid">
    ...
    <form method="post" action="insertar_etiqueta.php">
