...
$nombre_completo = $nombre_usuario . " " . $apellido_usuario;
        ...
        header("Location: index.php"); // Si no se ha iniciado sesión, redirigir al inicio de sesión
				...
				// Consultar la tabla
				$sql = "SELECT producto, ingreso, cantidad, Usuario, factura, proveedor FROM `historial-et-i`";
				$resultado = $conexion->query($sql);

				// Consultar la tabla
				$sqle = "SELECT producto, egreso, cantidad, Usuario FROM `historial-et-e`";
				$resultadoe = $conexion->query($sqle);

				// Consultar la tabla
				$sql1 = "SELECT producto, ingreso, cantidad, Usuario, factura, proveedor FROM `historial-c-i`";
				$resultado1 = $conexion->query($sql1);

				// Consultar la tabla
				$sqle1 = "SELECT producto, egreso, cantidad, Usuario FROM `historial-c-e`";
...
<div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
    <div class="mdl-tabs__tab-bar">
       <a href="#tabNewProduct" class="mdl-tabs__tab is-active">Etiquetas</a>
       <a href="#tabNewLote" class="mdl-tabs__tab">Colgantes</a>
     </div>
